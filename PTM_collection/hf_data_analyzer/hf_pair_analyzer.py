...
with open('./ModelTypes.json') as json_file:
...
with open('./LibraryToFrameworkMapping.json') as json_file:
    fw_dict = json.load(json_file)

with open('./downloaded.json', 'r') as f:
    downloaded_data = json.load(f)

with open('./searched.json', 'r') as f:
...
for to_search in data_set:
    ...
    with open('./searched.json', 'w') as f:
