...
os.environ["HF_HOME"] = "ANONYMIZED_PATH/cache_huggingface"
...
'''
l = read_model_from_json('././temp_models.json', "BertForMaskedLM")
auto_vectorize_nlp(
    l, 
    '././test_l.json', 
    '././test_p.json', 
...
def auto_vectorize_from_model_pickle(
    ...
    with open('././ptm_vectors/vec_p.json') as f:
        vec_p = json.load(f)
    with open('././ptm_vectors/vec_d.json') as f:
        vec_d = json.load(f)
    with open('././ptm_vectors/vec_l.json') as f:
        vec_l = json.load(f)
    ...
    with open('././ptm_vectors/vec_l.pkl', 'wb') as f:
        pickle.dump(p_vec_l, f)
    with open('././ptm_vectors/vec_d.pkl', 'wb') as f:
        pickle.dump(p_vec_d, f)
    with open('././ptm_vectors/vec_p.pkl', 'wb') as f:
        pickle.dump(p_vec_p, f)
    with open('././ptm_vectors/k_l.pkl', 'wb') as f:
        pickle.dump(k_l, f)
    with open('././ptm_vectors/k_d.pkl', 'wb') as f:
        pickle.dump(k_d, f)
    with open('././ptm_vectors/k_p.pkl', 'wb') as f:
        pickle.dump(k_p, f)
...
auto_vectorize_from_model_json(
    '././ptm_data',
    models_dict,
    '././ptm_vectors/vec_l.json',
    '././ptm_vectors/vec_p.json',
    '././ptm_vectors/vec_d.json'
    )
'''
